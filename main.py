...
def setup_pdef(panda_sim):
    ...
    for j in range(sim.pandaNumDofs):
        bounds_state.set_bounds(
            j, sim.pandaJointRange[j, 0], sim.pandaJointRange[j, 1])
...
############ camera angle ############
    p.resetDebugVisualizerCamera(
        ...
        cameraYaw=225,
        cameraPitch=-50,
        cameraTargetPosition=[0.4, 0.0, 0.0]
    )
#######################################
